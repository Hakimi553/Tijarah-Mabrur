...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"},"margin":{"bottom":"0"}}},"backgroundColor":"top-bar","className":"top-bar","layout":{"type":"constrained","contentSize":"80%"}} -->
<div class="wp-block-group top-bar has-top-bar-background-color has-background" style="margin-bottom:0;padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)"><!-- wp:columns {"verticalAlignment":"center","className":"wow fadeInDown"} -->
<div class="wp-block-columns are-vertically-aligned-center wow fadeInDown"><!-- wp:column {"verticalAlignment":"center","width":"10%","className":"topbar-new"} -->
...
<div class="wp-block-column is-vertically-aligned-center topbar-p" style="flex-basis:70%"><!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}},"typography":{"fontSize":"12px","fontStyle":"normal","fontWeight":"500"}},"textColor":"background"} -->
<p class="has-text-align-center has-background-color has-text-color has-link-color" style="font-size:12px;font-style:normal;font-weight:500"><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua','home-services-blocks'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"center","width":"20%","className":"social-block"} -->
<div class="wp-block-column is-vertically-aligned-center social-block" style="flex-basis:20%"><!-- wp:social-links {"iconColor":"background","iconColorValue":"#ffffff","size":"has-small-icon-size","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|40"}}},"className":"is-style-logos-only","layout":{"type":"flex","justifyContent":"right"}} -->
...
<!-- wp:group {"className":"upper-header ","style":{"spacing":{"padding":{"top":"0","bottom":"0"},"margin":{"bottom":"0"}}},"backgroundColor":"section-bg","layout":{"type":"constrained","contentSize":"80%"}} -->
<div class="wp-block-group upper-header has-section-bg-background-color has-background" style="margin-bottom:0;padding-top:0;padding-bottom:0"><!-- wp:columns {"verticalAlignment":"center"} -->
<div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center","width":"30%","className":"logo-block"} -->
<div class="wp-block-column is-vertically-aligned-center logo-block" style="flex-basis:30%"><!-- wp:site-title {"style":{"typography":{"textTransform":"capitalize"},"elements":{"link":{"color":{"text":"var:preset|color|heading"}}}},"textColor":"heading","fontSize":"regular","fontFamily":"barlow"} /--></div>
<!-- /wp:column -->
...
<div class="wp-block-column is-vertically-aligned-center info-uppper-box has-primary-background-color has-background" style="padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--50);flex-basis:70%"><!-- wp:columns {"verticalAlignment":"center","className":"inner-upper-header"} -->
<div class="wp-block-columns are-vertically-aligned-center inner-upper-header"><!-- wp:column {"verticalAlignment":"center","width":"","className":"info-box"} -->
...
<div class="wp-block-columns are-vertically-aligned-center inner-menu-header"><!-- wp:column {"verticalAlignment":"center","width":"80%","className":"nav-block"} -->
<div class="wp-block-column is-vertically-aligned-center nav-block" style="flex-basis:80%"><!-- wp:navigation {"textColor":"heading","overlayBackgroundColor":"white","overlayTextColor":"black","metadata":{"ignoredHookedBlocks":["woocommerce/customer-account","woocommerce/mini-cart"]},"style":{"typography":{"textTransform":"uppercase","letterSpacing":"1.5px"}},"fontSize":"small","layout":{"type":"flex","justifyContent":"left"}} -->
