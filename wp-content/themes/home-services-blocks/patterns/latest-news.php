...
<!-- wp:group {"style":{"spacing":{"margin":{"top":"0px","bottom":"0px"}}},"backgroundColor":"background","className":"blog-section","layout":{"type":"constrained","contentSize":"80%"}} -->
<div class="wp-block-group blog-section has-background-background-color has-background" style="margin-top:0px;margin-bottom:0px"><!-- wp:spacer {"height":"19px"} -->
...
<!-- wp:group {"className":"blog-box","layout":{"type":"constrained"}} -->
<div class="wp-block-group blog-box"><!-- wp:group {"className":"blog-inner","layout":{"type":"constrained"}} -->
