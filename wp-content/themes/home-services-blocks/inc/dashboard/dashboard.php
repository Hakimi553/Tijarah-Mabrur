...
function home_services_blocks_gettingstarted() {
	add_theme_page( esc_html__('Begin Installation', 'home-services-blocks'), esc_html__('Begin Installation', 'home-services-blocks'), 'edit_theme_options', 'home-services-blocks-guide-page', 'home_services_blocks_guide');
}
...
define('HOME_SERVICES_BLOCKS_LIVE_DEMO',__('https://trial.ovationthemes.com/home-services-blocks-pro/','home-services-blocks'));
}
if ( ! defined( 'HOME_SERVICES_BLOCKS_BUY_PRO' ) ) {
define('HOME_SERVICES_BLOCKS_BUY_PRO',__('https://www.ovationthemes.com/products/home-maintenance-wordpress-theme','home-services-blocks'));
}
if ( ! defined( 'HOME_SERVICES_BLOCKS_PRO_DOC' ) ) {
define('HOME_SERVICES_BLOCKS_PRO_DOC',__('https://trial.ovationthemes.com/docs/ot-home-services-blocks-pro-doc/','home-services-blocks'));
}
if ( ! defined( 'HOME_SERVICES_BLOCKS_FREE_DOC' ) ) {
define('HOME_SERVICES_BLOCKS_FREE_DOC',__('https://trial.ovationthemes.com/docs/ot-home-services-blocks-free-doc/','home-services-blocks'));
}
...
if ( ! defined( 'HOME_SERVICES_BLOCKS_BUNDLE_LINK' ) ) {
define('HOME_SERVICES_BLOCKS_BUNDLE_LINK',__('https://www.ovationthemes.com/products/wordpress-bundle','home-services-blocks'));
}
/**
 * Theme Info Page
 */
function home_services_blocks_guide() {
	...
	<div class="getting-started__header">
		<div class="header-box-left">
			...
			<p><?php esc_html_e('Version: ', 'home-services-blocks'); ?><?php echo esc_html($theme['Version']);?></p>
		</div>
	...
	<div class="wrap getting-started">
		<div class="box-container">
			...
			<div class="box-right-main">
				...
				<img class="home_services_blocks_img_responsive" style="width: 100%;" src="<?php echo esc_url( $theme->get_screenshot() ); ?>" />
				<div class="pro-links">
					<div class="pro-links-inner">
						...
						<a class="button-primary bundle-btn" href="<?php echo esc_url( HOME_SERVICES_BLOCKS_BUNDLE_LINK ); ?>" target="_blank"><?php esc_html_e('WordPress Theme Bundle (120+ Themes at Just $89)', 'home-services-blocks'); ?></a>
				</div>
